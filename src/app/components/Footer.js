        ...
        <div className="grid gap-16 lg:grid-cols-12 mb-20">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 text-gray-400 text-sm font-medium">
              ...
              <li><Link href="#" className="hover:text-white transition-colors">Albirr Schools</Link></li>
              <li><Link href="#" className="hover:text-white transition-colors">Albirr Members</Link></li>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <Link href="#" className="flex h-10 w-10 items-center justify-center rounded-full bg-white/5 border border-white/10 hover:bg-[#E1306C] transition-all">
                <svg className="h-5 w-5 fill-none stroke-white" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
              </Link>
              <Link href="#" className="flex h-10 w-10 items-center justify-center rounded-full bg-white/5 border border-white/10 hover:bg-[#1DA1F2] transition-all">
                <svg className="h-4 w-4 fill-white" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"></path></svg>
              </Link>
            </div>
          </div>
