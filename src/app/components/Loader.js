...
export default function Loader({ size = 45, color = "#ffffff", className = "" }) {
  return (
    <div className={"flex items-center justify-center " + className}>
      <div className="superballs" aria-label="Loading" role="img">
      ...
      <style jsx>{`
        ...
        .superballs__dot:nth-child(1)::before {
          animation: orbit82140 var(--uib-speed) linear
            calc(var(--uib-speed) * -0.143) infinite;
        }
