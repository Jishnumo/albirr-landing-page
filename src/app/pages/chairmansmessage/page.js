  ...
  return (
    <div className="relative min-h-screen text-white flex flex-col font-sans overflow-hidden bg-[#0b0830]">
      ...
      <main className="relative z-10 flex-grow w-full max-w-none px-0 pt-32 sm:pt-36 md:pt-44 lg:pt-48 xl:pt-52 pb-0 flex flex-col justify-center animate-in fade-in duration-500">
        ...
        <div className="relative overflow-visible min-h-[520px] p-6 sm:p-10 md:p-12 lg:p-16 flex flex-col justify-center mx-4 sm:mx-6 md:mx-8 xl:mx-12 rounded-2xl bg-white shadow-2xl">
            ...
            <div className="lg:col-span-3 flex flex-col justify-start">
              ...
              <div className="relative lg:hidden mb-6 w-full z-30">
                <button
                  ...
                  className="flex items-center justify-between w-full px-5 py-3.5 rounded-xl bg-black/[0.04] border border-black/10 text-gray-900 text-sm md:text-base font-semibold active:scale-98 transition-all duration-300 select-none cursor-pointer"
                >
            ...
            <div className="lg:col-span-9 flex flex-col justify-center">
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
                ...
                <div className="md:col-span-5 flex flex-col items-center justify-center">
                  ...
                  <div className="relative p-[3px] rounded-full bg-gradient-to-tr from-[#9C4A9C] via-[#36E1FF] to-[#F05B28] shadow-xl hover:scale-105 transition-all duration-500">
                  ...
                  <div className="mt-5 text-center px-2">
                    {/* Chairman name — bold dark navy on white */}
                    ...
                    {/* Role — solid purple pill with white text */}
