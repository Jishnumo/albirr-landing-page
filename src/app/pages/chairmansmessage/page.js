...
const ChairmansMessagePage = () => {
  ...
  return (
    <div className="relative min-h-screen text-white flex flex-col font-sans overflow-hidden bg-[#0b0830]">
      ...
      <header className="relative z-50 mx-auto w-full max-w-none px-4 sm:px-6 md:px-8 xl:px-12 pt-4 pb-6 md:pt-6 lg:pt-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden xl:flex items-center gap-8">
            ...
            <Link
              href="/pages/about"
              className="text-sm font-bold text-white border-b-2 border-white pb-1 transition"
            >
              About
            </Link>
            <Link
        ...
        {/* Mobile Drawer */}
        {isMenuOpen && (
          <div className="fixed inset-0 z-100 flex flex-col items-center justify-center bg-[#0b0830] xl:hidden animate-in fade-in duration-300">
            <button
            ...
            <div className="flex flex-col items-center gap-8 text-center px-6 w-full max-w-sm">
              ...
              <Link
                href="/pages/about"
                onClick={() => setIsMenuOpen(false)}
                className="text-2xl font-semibold text-[#36E1FF] transition"
              >
                About
              </Link>
              <Link
      ...
      {/* Main Content */}
      <main className="relative z-10 grow w-full max-w-none px-0 pt-4 md:pt-8 pb-0 flex flex-col justify-center animate-in fade-in duration-500">
        {/* Page Title */}
        ...
        <div className="relative overflow-visible min-h-130 p-6 sm:p-10 md:p-12 lg:p-16 flex flex-col justify-center mx-4 sm:mx-6 md:mx-8 xl:mx-12 rounded-2xl">
                ...
                {tabs.map((tab) => {
                  ...
                  return (
                    <Link
                      key={tab.id}
                      href={tab.path}
                      className={`flex items-center px-6 py-3 rounded-xl lg:rounded-full text-left text-sm md:text-base font-bold whitespace-nowrap lg:whitespace-normal transition-all duration-300 select-none ${
                        isActive
                          ? "bg-black/8 border border-black/5 text-gray-900 shadow-sm font-extrabold"
                          : "text-gray-600 hover:text-gray-950 hover:bg-black/3 border border-transparent"
                      }`}
                    >
                      <span>{tab.label}</span>
                    </Link>
            ...
            <div className="lg:col-span-9 flex flex-col justify-center">
              <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 items-center">
                ...
                <div className="md:col-span-7 space-y-6 text-left">
                  <div className="space-y-4 text-xs sm:text-sm lg:text-[0.82rem] leading-relaxed text-gray-700 font-normal">
                    ...
                    <p className="text-justify font-normal">
                      At Albirr we provide a totally balanced environment
                      focused not only on academic progress of the child but
                      also their physical, social and emotional development. All
                      our centres boasts of state of the art infrastructure with
                      libraries, laboratories for computer and science, play
                      area and well equipped classrooms.
                    </p>
                    <p className="text-justify font-normal">
                      We provide a conducive environment for children to play as
                      well as explore and learn. The classrooms are very
                      spacious and well-lit and ventilated keeping in mind the
                      comfort and free movement of the children. Our smart and
                      Hi-tech classrooms are equipped with Projector,
                      Television, White board, Green board, Pin board etc. They
                      are painted with bright colours and adorned with various
                      colourful teaching and learning aids for better learning
                      experiences.
                    </p>
                  </div>
                </div>
                ...
                <div className="md:col-span-5 flex flex-col items-center justify-center">
                  <div className="relative group p-1.5 rounded-full bg-linear-to-tr from-[#9C4A9C] via-[#36E1FF] to-[#F05B28] shadow-xl hover:scale-105 transition-all duration-500">
